...
const ShimmerUI = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 m-4">
        {Array.from({length:12}).map(()=>(
            <div className="animate-pulse p-4 border border-gray-900 rounded-xl-lgbg-white shadow-md">
            <div className="h-40 border-2 border-gray-900 bg-gray-900 rounded-xl">
            <div className="mt-4">
