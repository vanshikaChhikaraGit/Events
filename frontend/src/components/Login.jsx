...
import { Mail, MessageSquare,LockKeyhole,Eye,EyeOff, Loader2 } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
       ...
       <div className="w-full max-w-md space-y-8">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
           ...
           <div className="form-control">
            ...
            <div className="relative">
              ...
              <input 
              className="w-full pl-10 input input-bordered p-3"
        ...
        <div>
          <button className="btn btn-primary w-full flex items-center justify-center text-center border-4 p-5 cursor-pointer rounded-2xl hover:border-blue-700 bg-white/80 text-black" type="submit" disabled={isLoggingIn}>
         ...
         <div className='text-center'>
              ...
              <span className='text-[#2290ff] underline'>SignUp</span> </Link></p>
         </div>
       </form>
       </div>
       </div>
       ...
       {/* rightside */}
       <div>
       <AuthImagePattern title={"Welcome Back!"} subtitle={"Stay in the loop and never miss out on the dopest events, shows, and music!"}></AuthImagePattern>
       </div>
