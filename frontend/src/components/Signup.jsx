  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center p-6 sm:p-12">
      <div className="w-full max-w-md space-y-8">
        ...
        <div>
            <button type='submit' className="btn btn-primary flex items-center justify-center w-full border-4 border-white/90 rounded-2xl hover:border-blue-700 bg-white/80 text-black cursor-pointer p-5" disabled={isSigningIn} >{ isSigningIn? 
        ...
        <p className="text-base-content/60">
              ...
              <Link to="/login" className="link link-primary">
                <span className='text-[#2290ff] underline'>Login</span>
              </Link>
            </p>
        </div>
    ...
    {/* right side */}
    <div>
        <AuthImagePattern title={"Welcome to the vibe zone! "} subtitle={"Stay in the loop and never miss out on the dopest events, shows, and music!"}/>
    </div>
